...
func HasNode() predicate.SideEffectTask {
	return predicate.SideEffectTask(func(s *sql.Selector) {
...
func HasNodeWith(preds ...predicate.Node) predicate.SideEffectTask {
	return predicate.SideEffectTask(func(s *sql.Selector) {
		step := newNodeStep()
