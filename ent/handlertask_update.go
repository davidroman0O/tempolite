...
func (htu *HandlerTaskUpdate) SetTaskType(ht handlertask.TaskType) *HandlerTaskUpdate {
	htu.mutation.SetTaskType(ht)
	return htu
}

// SetNillableTaskType sets the "task_type" field if the given value is not nil.
func (htu *HandlerTaskUpdate) SetNillableTaskType(ht *handlertask.TaskType) *HandlerTaskUpdate {
	if ht != nil {
		htu.SetTaskType(*ht)
	}
	return htu
...
func (htu *HandlerTaskUpdate) check() error {
	if v, ok := htu.mutation.TaskType(); ok {
		if err := handlertask.TaskTypeValidator(v); err != nil {
			return &ValidationError{Name: "task_type", err: fmt.Errorf(`ent: validator failed for field "HandlerTask.task_type": %w`, err)}
		}
	}
...
func (htu *HandlerTaskUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := htu.mutation.TaskType(); ok {
		_spec.SetField(handlertask.FieldTaskType, field.TypeEnum, value)
	}
...
// SetTaskType sets the "task_type" field.
func (htuo *HandlerTaskUpdateOne) SetTaskType(ht handlertask.TaskType) *HandlerTaskUpdateOne {
	htuo.mutation.SetTaskType(ht)
	return htuo
}

// SetNillableTaskType sets the "task_type" field if the given value is not nil.
func (htuo *HandlerTaskUpdateOne) SetNillableTaskType(ht *handlertask.TaskType) *HandlerTaskUpdateOne {
	if ht != nil {
		htuo.SetTaskType(*ht)
	}
	return htuo
...
func (htuo *HandlerTaskUpdateOne) check() error {
	if v, ok := htuo.mutation.TaskType(); ok {
		if err := handlertask.TaskTypeValidator(v); err != nil {
			return &ValidationError{Name: "task_type", err: fmt.Errorf(`ent: validator failed for field "HandlerTask.task_type": %w`, err)}
		}
	}
...
func (htuo *HandlerTaskUpdateOne) sqlSave(ctx context.Context) (_node *HandlerTask, err error) {
	...
	if value, ok := htuo.mutation.TaskType(); ok {
		_spec.SetField(handlertask.FieldTaskType, field.TypeEnum, value)
	}
