...
type SideEffectExecutionDataQuery struct {
	...
	withExecution *SideEffectExecutionQuery
...
func (seedq *SideEffectExecutionDataQuery) QueryExecution() *SideEffectExecutionQuery {
...
func (seedq *SideEffectExecutionDataQuery) FirstID(ctx context.Context) (id schema.SideEffectExecutionDataID, err error) {
	var ids []schema.SideEffectExecutionDataID
...
func (seedq *SideEffectExecutionDataQuery) FirstIDX(ctx context.Context) schema.SideEffectExecutionDataID {
...
func (seedq *SideEffectExecutionDataQuery) OnlyID(ctx context.Context) (id schema.SideEffectExecutionDataID, err error) {
	var ids []schema.SideEffectExecutionDataID
...
func (seedq *SideEffectExecutionDataQuery) OnlyIDX(ctx context.Context) schema.SideEffectExecutionDataID {
...
func (seedq *SideEffectExecutionDataQuery) IDs(ctx context.Context) (ids []schema.SideEffectExecutionDataID, err error) {
...
func (seedq *SideEffectExecutionDataQuery) IDsX(ctx context.Context) []schema.SideEffectExecutionDataID {
...
func (seedq *SideEffectExecutionDataQuery) Clone() *SideEffectExecutionDataQuery {
	...
	return &SideEffectExecutionDataQuery{
		...
		withExecution: seedq.withExecution.Clone(),
...
func (seedq *SideEffectExecutionDataQuery) WithExecution(opts ...func(*SideEffectExecutionQuery)) *SideEffectExecutionDataQuery {
	query := (&SideEffectExecutionClient{config: seedq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	seedq.withExecution = query
	return seedq
}
...
//		GroupBy(sideeffectexecutiondata.FieldExecutionID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.SideEffectExecutionData.Query().
//		Select(sideeffectexecutiondata.FieldExecutionID).
//		Scan(ctx, &v)
...
func (seedq *SideEffectExecutionDataQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SideEffectExecutionData, error) {
	...
	if query := seedq.withExecution; query != nil {
		if err := seedq.loadExecution(ctx, query, nodes, nil,
			func(n *SideEffectExecutionData, e *SideEffectExecution) { n.Edges.Execution = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (seedq *SideEffectExecutionDataQuery) loadExecution(ctx context.Context, query *SideEffectExecutionQuery, nodes []*SideEffectExecutionData, init func(*SideEffectExecutionData), assign func(*SideEffectExecutionData, *SideEffectExecution)) error {
	ids := make([]schema.SideEffectExecutionID, 0, len(nodes))
	nodeids := make(map[schema.SideEffectExecutionID][]*SideEffectExecutionData)
	for i := range nodes {
...
func (seedq *SideEffectExecutionDataQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := seedq.ctx.Fields; len(fields) > 0 {
		...
		if seedq.withExecution != nil {
			_spec.Node.AddColumnOnce(sideeffectexecutiondata.FieldExecutionID)
		}
	}
