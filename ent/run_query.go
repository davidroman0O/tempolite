...
func (rq *RunQuery) FirstID(ctx context.Context) (id schema.RunID, err error) {
	var ids []schema.RunID
...
func (rq *RunQuery) FirstIDX(ctx context.Context) schema.RunID {
...
func (rq *RunQuery) OnlyID(ctx context.Context) (id schema.RunID, err error) {
	var ids []schema.RunID
...
func (rq *RunQuery) OnlyIDX(ctx context.Context) schema.RunID {
...
func (rq *RunQuery) IDs(ctx context.Context) (ids []schema.RunID, err error) {
...
func (rq *RunQuery) IDsX(ctx context.Context) []schema.RunID {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
