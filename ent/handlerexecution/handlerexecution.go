...
const (
	...
	EdgeTasks = "tasks"
	// EdgeSagaStepExecution holds the string denoting the saga_step_execution edge name in mutations.
	EdgeSagaStepExecution = "saga_step_execution"
	...
	// SagaStepExecutionTable is the table that holds the saga_step_execution relation/edge.
	SagaStepExecutionTable = "handler_executions"
	// SagaStepExecutionInverseTable is the table name for the SagaStepExecution entity.
	// It exists in this package in order to avoid circular dependency with the "sagastepexecution" package.
	SagaStepExecutionInverseTable = "saga_step_executions"
	// SagaStepExecutionColumn is the table column denoting the saga_step_execution relation/edge.
	SagaStepExecutionColumn = "handler_execution_saga_step_execution"
)
...
var ForeignKeys = []string{
	...
	"handler_execution_saga_step_execution",
}
...
// BySagaStepExecutionField orders the results by saga_step_execution field.
func BySagaStepExecutionField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newSagaStepExecutionStep(), sql.OrderByField(field, opts...))
	}
}
...
func newSagaStepExecutionStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(SagaStepExecutionInverseTable, FieldID),
