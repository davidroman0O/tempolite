...
func (heu *HandlerExecutionUpdate) SetNillableExecutionContextID(id *string) *HandlerExecutionUpdate {
	if id != nil {
		heu = heu.SetExecutionContextID(*id)
	}
	return heu
}
...
// SetNillableExecutionContextID sets the "execution_context" edge to the ExecutionContext entity by ID if the given value is not nil.
func (heuo *HandlerExecutionUpdateOne) SetNillableExecutionContextID(id *string) *HandlerExecutionUpdateOne {
	if id != nil {
		heuo = heuo.SetExecutionContextID(*id)
	}
	return heuo
}
