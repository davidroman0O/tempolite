...
const (
	...
	ExecutionTable = "activity_execution_data"
	// ExecutionInverseTable is the table name for the ActivityExecution entity.
	// It exists in this package in order to avoid circular dependency with the "activityexecution" package.
	ExecutionInverseTable = "activity_executions"
