...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			activitydata.Table:            activitydata.ValidColumn,
			...
			sagadata.Table:                sagadata.ValidColumn,
			sagaentity.Table:              sagaentity.ValidColumn,
			sagaexecution.Table:           sagaexecution.ValidColumn,
			sagaexecutiondata.Table:       sagaexecutiondata.ValidColumn,
			sagavalue.Table:               sagavalue.ValidColumn,
			sideeffectdata.Table:          sideeffectdata.ValidColumn,
			sideeffectentity.Table:        sideeffectentity.ValidColumn,
			sideeffectexecution.Table:     sideeffectexecution.ValidColumn,
			sideeffectexecutiondata.Table: sideeffectexecutiondata.ValidColumn,
			signaldata.Table:              signaldata.ValidColumn,
			signalentity.Table:            signalentity.ValidColumn,
			signalexecution.Table:         signalexecution.ValidColumn,
			signalexecutiondata.Table:     signalexecutiondata.ValidColumn,
			version.Table:                 version.ValidColumn,
			workflowdata.Table:            workflowdata.ValidColumn,
			workflowentity.Table:          workflowentity.ValidColumn,
			workflowexecution.Table:       workflowexecution.ValidColumn,
			workflowexecutiondata.Table:   workflowexecutiondata.ValidColumn,
		})
	})
