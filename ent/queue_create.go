...
func (qc *QueueCreate) SetID(si schema.QueueID) *QueueCreate {
	qc.mutation.SetID(si)
	return qc
}

// AddEntityIDs adds the "entities" edge to the WorkflowEntity entity by IDs.
func (qc *QueueCreate) AddEntityIDs(ids ...schema.WorkflowEntityID) *QueueCreate {
	qc.mutation.AddEntityIDs(ids...)
	return qc
}

// AddEntities adds the "entities" edges to the WorkflowEntity entity.
func (qc *QueueCreate) AddEntities(w ...*WorkflowEntity) *QueueCreate {
