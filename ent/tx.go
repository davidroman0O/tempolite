...
func (tx *Tx) init() {
	tx.ActivityData = NewActivityDataClient(tx.config)
	...
	tx.SagaData = NewSagaDataClient(tx.config)
	tx.SagaEntity = NewSagaEntityClient(tx.config)
	tx.SagaExecution = NewSagaExecutionClient(tx.config)
	tx.SagaExecutionData = NewSagaExecutionDataClient(tx.config)
	tx.SagaValue = NewSagaValueClient(tx.config)
	tx.SideEffectData = NewSideEffectDataClient(tx.config)
	tx.SideEffectEntity = NewSideEffectEntityClient(tx.config)
	tx.SideEffectExecution = NewSideEffectExecutionClient(tx.config)
	tx.SideEffectExecutionData = NewSideEffectExecutionDataClient(tx.config)
	tx.SignalData = NewSignalDataClient(tx.config)
	tx.SignalEntity = NewSignalEntityClient(tx.config)
	tx.SignalExecution = NewSignalExecutionClient(tx.config)
	tx.SignalExecutionData = NewSignalExecutionDataClient(tx.config)
	tx.Version = NewVersionClient(tx.config)
	tx.WorkflowData = NewWorkflowDataClient(tx.config)
	tx.WorkflowEntity = NewWorkflowEntityClient(tx.config)
	tx.WorkflowExecution = NewWorkflowExecutionClient(tx.config)
	tx.WorkflowExecutionData = NewWorkflowExecutionDataClient(tx.config)
}
...
// applies a query, for example: ActivityData.QueryXXX(), the query will be executed
