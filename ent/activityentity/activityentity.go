...
const (
	// Label holds the string label denoting the activityentity type in the database.
	Label = "activity_entity"
	...
	// Table holds the table name of the activityentity in the database.
	Table = "activity_entities"
	// WorkflowTable is the table that holds the workflow relation/edge.
	WorkflowTable = "activity_entities"
	...
	WorkflowColumn = "workflow_entity_activity_children"
	...
	ExecutionsColumn = "activity_entity_id"
)

// Columns holds all SQL columns for activityentity fields.
var Columns = []string{
	FieldID,
	FieldHandlerName,
	FieldType,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "activity_entities"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"workflow_entity_activity_children",
}
...
// OrderOption defines the ordering options for the ActivityEntity queries.
