...
func TestWorkflowExecuteSagaFuncs(t *testing.T) {
	registry := tempolite.NewRegistry()
	database := tempolite.NewMemoryDatabase()
	defer database.SaveAsJSON("./jsons/workflows_basic_saga_execute_funcs.json")
...
func TestWorkflowExecuteSagaFuncsFailure(t *testing.T) {
	registry := tempolite.NewRegistry()
	database := tempolite.NewMemoryDatabase()
	defer database.SaveAsJSON("./jsons/workflows_basic_saga_execute_funcs_failure.json")
	ctx := context.Background()
...
func TestWorkflowExecuteSagaFuncsPanic(t *testing.T) {
	registry := tempolite.NewRegistry()
	database := tempolite.NewMemoryDatabase()
	defer database.SaveAsJSON("./jsons/workflows_basic_saga_execute_funcs_panic.json")
	ctx := context.Background()
