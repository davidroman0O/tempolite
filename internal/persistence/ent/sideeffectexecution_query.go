...
func (seeq *SideEffectExecutionQuery) QueryExecution() *ExecutionQuery {
	query := (&ExecutionClient{config: seeq.config}).Query()
...
func (seeq *SideEffectExecutionQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (seeq *SideEffectExecutionQuery) FirstIDX(ctx context.Context) int {
...
func (seeq *SideEffectExecutionQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (seeq *SideEffectExecutionQuery) OnlyIDX(ctx context.Context) int {
...
func (seeq *SideEffectExecutionQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (seeq *SideEffectExecutionQuery) IDsX(ctx context.Context) []int {
...
func (seeq *SideEffectExecutionQuery) Clone() *SideEffectExecutionQuery {
	...
	return &SideEffectExecutionQuery{
		...
		withExecution:     seeq.withExecution.Clone(),
...
func (seeq *SideEffectExecutionQuery) WithExecution(opts ...func(*ExecutionQuery)) *SideEffectExecutionQuery {
	query := (&ExecutionClient{config: seeq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	seeq.withExecution = query
	return seeq
}
...
func (seeq *SideEffectExecutionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SideEffectExecution, error) {
	var (
		...
		loadedTypes = [2]bool{
			seeq.withExecution != nil,
			seeq.withExecutionData != nil,
		}
	)
	if seeq.withExecution != nil {
		withFKs = true
	}
	if withFKs {
	...
	if query := seeq.withExecution; query != nil {
		if err := seeq.loadExecution(ctx, query, nodes, nil,
			func(n *SideEffectExecution, e *Execution) { n.Edges.Execution = e }); err != nil {
			return nil, err
		}
	}
...
func (seeq *SideEffectExecutionQuery) loadExecution(ctx context.Context, query *ExecutionQuery, nodes []*SideEffectExecution, init func(*SideEffectExecution), assign func(*SideEffectExecution, *Execution)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*SideEffectExecution)
	for i := range nodes {
		if nodes[i].execution_side_effect_execution == nil {
			continue
		}
		fk := *nodes[i].execution_side_effect_execution
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "execution_side_effect_execution" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (seeq *SideEffectExecutionQuery) loadExecutionData(ctx context.Context, query *SideEffectExecutionDataQuery, nodes []*SideEffectExecution, init func(*SideEffectExecution), assign func(*SideEffectExecution, *SideEffectExecutionData)) error {
	...
	for _, n := range neighbors {
		fk := n.side_effect_execution_execution_data
		if fk == nil {
			return fmt.Errorf(`foreign-key "side_effect_execution_execution_data" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "side_effect_execution_execution_data" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
