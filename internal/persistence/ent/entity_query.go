...
func (eq *EntityQuery) QueryRun() *RunQuery {
	query := (&RunClient{config: eq.config}).Query()
...
func (eq *EntityQuery) QueryExecutions() *ExecutionQuery {
	query := (&ExecutionClient{config: eq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := eq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (eq *EntityQuery) QueryVersions() *VersionQuery {
	query := (&VersionClient{config: eq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := eq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (eq *EntityQuery) QueryWorkflowData() *WorkflowDataQuery {
	query := (&WorkflowDataClient{config: eq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := eq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (eq *EntityQuery) QueryActivityData() *ActivityDataQuery {
	query := (&ActivityDataClient{config: eq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := eq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (eq *EntityQuery) QuerySagaData() *SagaDataQuery {
	query := (&SagaDataClient{config: eq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := eq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (eq *EntityQuery) QuerySideEffectData() *SideEffectDataQuery {
	query := (&SideEffectDataClient{config: eq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := eq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (eq *EntityQuery) Clone() *EntityQuery {
	...
	return &EntityQuery{
		...
		withSagaData:       eq.withSagaData.Clone(),
		withSideEffectData: eq.withSideEffectData.Clone(),
...
func (eq *EntityQuery) WithRun(opts ...func(*RunQuery)) *EntityQuery {
	query := (&RunClient{config: eq.config}).Query()
...
func (eq *EntityQuery) WithExecutions(opts ...func(*ExecutionQuery)) *EntityQuery {
	query := (&ExecutionClient{config: eq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	eq.withExecutions = query
	return eq
}
...
func (eq *EntityQuery) WithVersions(opts ...func(*VersionQuery)) *EntityQuery {
	query := (&VersionClient{config: eq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	eq.withVersions = query
	return eq
}
...
func (eq *EntityQuery) WithWorkflowData(opts ...func(*WorkflowDataQuery)) *EntityQuery {
	query := (&WorkflowDataClient{config: eq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	eq.withWorkflowData = query
	return eq
}
...
func (eq *EntityQuery) WithActivityData(opts ...func(*ActivityDataQuery)) *EntityQuery {
	query := (&ActivityDataClient{config: eq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	eq.withActivityData = query
	return eq
}
...
func (eq *EntityQuery) WithSagaData(opts ...func(*SagaDataQuery)) *EntityQuery {
	query := (&SagaDataClient{config: eq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	eq.withSagaData = query
	return eq
}
...
func (eq *EntityQuery) WithSideEffectData(opts ...func(*SideEffectDataQuery)) *EntityQuery {
	query := (&SideEffectDataClient{config: eq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	eq.withSideEffectData = query
	return eq
}
...
func (eq *EntityQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Entity, error) {
	...
	if query := eq.withRun; query != nil {
		if err := eq.loadRun(ctx, query, nodes, nil,
			func(n *Entity, e *Run) { n.Edges.Run = e }); err != nil {
			return nil, err
		}
	}
	if query := eq.withExecutions; query != nil {
		if err := eq.loadExecutions(ctx, query, nodes,
			func(n *Entity) { n.Edges.Executions = []*Execution{} },
			func(n *Entity, e *Execution) { n.Edges.Executions = append(n.Edges.Executions, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := eq.withVersions; query != nil {
		if err := eq.loadVersions(ctx, query, nodes,
			func(n *Entity) { n.Edges.Versions = []*Version{} },
			func(n *Entity, e *Version) { n.Edges.Versions = append(n.Edges.Versions, e) }); err != nil {
			return nil, err
		}
	}
	if query := eq.withWorkflowData; query != nil {
		if err := eq.loadWorkflowData(ctx, query, nodes, nil,
			func(n *Entity, e *WorkflowData) { n.Edges.WorkflowData = e }); err != nil {
			return nil, err
		}
	}
	if query := eq.withActivityData; query != nil {
		if err := eq.loadActivityData(ctx, query, nodes, nil,
			func(n *Entity, e *ActivityData) { n.Edges.ActivityData = e }); err != nil {
			return nil, err
		}
	}
	if query := eq.withSagaData; query != nil {
		if err := eq.loadSagaData(ctx, query, nodes, nil,
			func(n *Entity, e *SagaData) { n.Edges.SagaData = e }); err != nil {
			return nil, err
		}
	}
	if query := eq.withSideEffectData; query != nil {
		if err := eq.loadSideEffectData(ctx, query, nodes, nil,
			func(n *Entity, e *SideEffectData) { n.Edges.SideEffectData = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (eq *EntityQuery) loadRun(ctx context.Context, query *RunQuery, nodes []*Entity, init func(*Entity), assign func(*Entity, *Run)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Entity)
	for i := range nodes {
		if nodes[i].run_entities == nil {
			continue
		}
		fk := *nodes[i].run_entities
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "run_entities" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (eq *EntityQuery) loadExecutions(ctx context.Context, query *ExecutionQuery, nodes []*Entity, init func(*Entity), assign func(*Entity, *Execution)) error {
	...
	query.Where(predicate.Execution(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(entity.ExecutionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.entity_executions
		if fk == nil {
			return fmt.Errorf(`foreign-key "entity_executions" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "entity_executions" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (eq *EntityQuery) loadVersions(ctx context.Context, query *VersionQuery, nodes []*Entity, init func(*Entity), assign func(*Entity, *Version)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Entity)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Version(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(entity.VersionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.entity_versions
		if fk == nil {
			return fmt.Errorf(`foreign-key "entity_versions" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "entity_versions" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (eq *EntityQuery) loadWorkflowData(ctx context.Context, query *WorkflowDataQuery, nodes []*Entity, init func(*Entity), assign func(*Entity, *WorkflowData)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Entity)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.WorkflowData(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(entity.WorkflowDataColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.entity_workflow_data
		if fk == nil {
			return fmt.Errorf(`foreign-key "entity_workflow_data" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "entity_workflow_data" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (eq *EntityQuery) loadActivityData(ctx context.Context, query *ActivityDataQuery, nodes []*Entity, init func(*Entity), assign func(*Entity, *ActivityData)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Entity)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.ActivityData(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(entity.ActivityDataColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.entity_activity_data
		if fk == nil {
			return fmt.Errorf(`foreign-key "entity_activity_data" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "entity_activity_data" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (eq *EntityQuery) loadSagaData(ctx context.Context, query *SagaDataQuery, nodes []*Entity, init func(*Entity), assign func(*Entity, *SagaData)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Entity)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.SagaData(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(entity.SagaDataColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.entity_saga_data
		if fk == nil {
			return fmt.Errorf(`foreign-key "entity_saga_data" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "entity_saga_data" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (eq *EntityQuery) loadSideEffectData(ctx context.Context, query *SideEffectDataQuery, nodes []*Entity, init func(*Entity), assign func(*Entity, *SideEffectData)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Entity)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.SideEffectData(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(entity.SideEffectDataColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.entity_side_effect_data
		if fk == nil {
			return fmt.Errorf(`foreign-key "entity_side_effect_data" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "entity_side_effect_data" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
