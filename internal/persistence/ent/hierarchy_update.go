...
func (hu *HierarchyUpdate) SetRunID(i int) *HierarchyUpdate {
	hu.mutation.SetRunID(i)
	return hu
}

// SetNillableRunID sets the "run_id" field if the given value is not nil.
func (hu *HierarchyUpdate) SetNillableRunID(i *int) *HierarchyUpdate {
	if i != nil {
		hu.SetRunID(*i)
	}
	return hu
...
func (hu *HierarchyUpdate) SetParentEntity(e *Entity) *HierarchyUpdate {
	return hu.SetParentEntityID(e.ID)
}

// SetChildEntity sets the "child_entity" edge to the Entity entity.
func (hu *HierarchyUpdate) SetChildEntity(e *Entity) *HierarchyUpdate {
	return hu.SetChildEntityID(e.ID)
}
...
func (hu *HierarchyUpdate) ClearParentEntity() *HierarchyUpdate {
	hu.mutation.ClearParentEntity()
	return hu
}

// ClearChildEntity clears the "child_entity" edge to the Entity entity.
func (hu *HierarchyUpdate) ClearChildEntity() *HierarchyUpdate {
	hu.mutation.ClearChildEntity()
	return hu
}
...
func (hu *HierarchyUpdate) check() error {
	...
	if hu.mutation.ParentEntityCleared() && len(hu.mutation.ParentEntityIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Hierarchy.parent_entity"`)
	}
	if hu.mutation.ChildEntityCleared() && len(hu.mutation.ChildEntityIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Hierarchy.child_entity"`)
	}
	return nil
}
...
func (hu *HierarchyUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if hu.mutation.ParentEntityCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
	...
	if nodes := hu.mutation.ParentEntityIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   hierarchy.ParentEntityTable,
	...
	if hu.mutation.ChildEntityCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
	...
	if nodes := hu.mutation.ChildEntityIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   hierarchy.ChildEntityTable,
...
// SetRunID sets the "run_id" field.
func (huo *HierarchyUpdateOne) SetRunID(i int) *HierarchyUpdateOne {
	huo.mutation.SetRunID(i)
	return huo
}

// SetNillableRunID sets the "run_id" field if the given value is not nil.
func (huo *HierarchyUpdateOne) SetNillableRunID(i *int) *HierarchyUpdateOne {
	if i != nil {
		huo.SetRunID(*i)
	}
	return huo
...
// SetParentEntity sets the "parent_entity" edge to the Entity entity.
func (huo *HierarchyUpdateOne) SetParentEntity(e *Entity) *HierarchyUpdateOne {
	return huo.SetParentEntityID(e.ID)
}

// SetChildEntity sets the "child_entity" edge to the Entity entity.
func (huo *HierarchyUpdateOne) SetChildEntity(e *Entity) *HierarchyUpdateOne {
	return huo.SetChildEntityID(e.ID)
}
...
// ClearParentEntity clears the "parent_entity" edge to the Entity entity.
func (huo *HierarchyUpdateOne) ClearParentEntity() *HierarchyUpdateOne {
	huo.mutation.ClearParentEntity()
	return huo
}

// ClearChildEntity clears the "child_entity" edge to the Entity entity.
func (huo *HierarchyUpdateOne) ClearChildEntity() *HierarchyUpdateOne {
	huo.mutation.ClearChildEntity()
	return huo
}
...
func (huo *HierarchyUpdateOne) check() error {
	...
	if huo.mutation.ParentEntityCleared() && len(huo.mutation.ParentEntityIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Hierarchy.parent_entity"`)
	}
	if huo.mutation.ChildEntityCleared() && len(huo.mutation.ChildEntityIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Hierarchy.child_entity"`)
	}
	return nil
}
...
func (huo *HierarchyUpdateOne) sqlSave(ctx context.Context) (_node *Hierarchy, err error) {
	...
	if huo.mutation.ParentEntityCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   hierarchy.ParentEntityTable,
	...
	if nodes := huo.mutation.ParentEntityIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   hierarchy.ParentEntityTable,
	...
	if huo.mutation.ChildEntityCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   hierarchy.ChildEntityTable,
	...
	if nodes := huo.mutation.ChildEntityIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   hierarchy.ChildEntityTable,
